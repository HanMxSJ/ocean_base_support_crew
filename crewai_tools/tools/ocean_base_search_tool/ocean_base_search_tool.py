...
##OceanBaseSearchTool
class OceanBaseSearchToolSchema(BaseModel):
    """Input for OceanBaseSearchTool."""
...
class OceanBaseSearchTool(RagTool):
    ...
    args_schema: Type[BaseModel] = OceanBaseSearchToolSchema
    ...
    def add(
        ...
        **kwargs: Any,
        ...
        # data_type 和 loader 使用 ocean base 定制的工具
        kwargs["data_type"] = "mysql"
        kwargs["loader"] = OceanBaseLoader(config=dict(url=self.db_uri))
